...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The exports you receive when you purchase an export bundle never expire. Exports received as part of a subscription expire at the end of each calendar month and do not carry over to the next calendar month.",
  },
  {
...
interface PricingColumnProps {
  title: string;
  description: string;
  products: { exports: number; price: number; suffix?: string }[];
    ...
    <div className="divide-y divide-gray-200 rounded-lg border border-gray-200 shadow-sm relative flex">
      ...
      <div className="p-6 pt-8 flex flex-col w-full">
        ...
        <ul className="mt-6 space-y-4 grow">
          {products.map((p) => (
            <li key={p.exports} className="grid grid-cols-2">
              <div>
                {p.exports} Exports {p.suffix && "per month"}
              </div>
        ...
        <div className="flex flex-col gap-y-4 mt-8 ">
          <p className="text-slate-600 text-center">
            ...
            <span className="font-bold">5 free exports</span> to try out
            Cloudpress!
          </p>
          <a
        ...
        <div className="max-w-7xl mx-auto bg-white py-16 sm:py-24 sm:px-6 lg:px-8 px-4">
          <div className="space-y-4 grid sm:grid-cols-1 md:grid-cols-2 gap-6 sm:space-y-0 lg:mx-auto lg:max-w-4xl xl:mx-0 xl:max-w-none xl:grid-cols-3">
            <PricingColumn
              ...
              description="Export bundles allow you to export content without any long term financial commitment."
              products={[
                { exports: 20, price: 29 },
                { exports: 50, price: 69 },
                { exports: 100, price: 129 },
                { exports: 200, price: 219 },
                { exports: 500, price: 509 },
                { exports: 1000, price: 999 },
              ]}
            />
            <PricingColumn
              ...
              products={[
                { exports: 25, price: 19, suffix: "month" },
                {
                  exports: 50,
                  price: 29,
                  suffix: "month",
            ...
            <PricingColumn
              ...
              products={[
                { exports: 25, price: 190, suffix: "year" },
                {
                  exports: 50,
                  price: 290,
                  suffix: "year",
