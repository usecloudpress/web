...
const faqs = [
  {
    question: "Is it free to convert my document to HTML?",
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        unlimited documents to HTML. This is included in{" "}
        <Link
  ...
  {
    question: "Can you export to my CMS?",
    answer: (
      <>
  ...
  },
  {
    ...
    answer:
      "We temporarily store your document's content on our servers so the background process can access it to export it to HTML. Once the export is complete, the content is removed from our servers.",
  },
  {
    question: "How long can I access the exported content?",
    answer:
      "We will email you a download link when the export is complete. This download link is valid for 24 hours. The ZIP file containing the exported HTML and images is removed afterwards.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Occasionally, we encounter a document that contains content that trips up our HTML converter. If this happens, you will receive an email indicating that the export failed. We encourage you to contact us at hello@usecloudpress.com to see if we can figure out the problem.",
  },
  {
    question:
      "I have another question not addressed here. How can I contact you?",
    answer:
      "We would love to hear from you. Send us an email at hello@usecloudpress.com.",
  },
];
