          ...
          <section className="xl mx-auto lg:max-w-4xl ">
            <div className="text-center">
              ...
              <p className="mt-8 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:text-2xl md:max-w-3xl">
                Write and collaborate in Google Docs, then export your document
                to Contentful with the click of a button
              </p>
            </div>
          </section>
        </div>
        ...
        <div className="bg-gray-50">
          <div className="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            <h2 className="text-3xl leading-9 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
              Ready to export your first document to Contentful?
              <span className="text-brand-600 block pt-5">
