          ...
          <div>
            ...
            <div className="prose max-w-none mt-8">
              <p>
                ...
                the use of Cloudpress&apos;s Website.
              </p>
              <p>
                By accessing this website we assume you accept these terms and
                conditions in full. Do not continue to use Cloudpress&apos;s
              ...
              <h2>License</h2>
              <p>
                Unless otherwise stated, Cloudpress and/or it&apos;s licensors
                own the intellectual property rights for all material on
                Cloudpress. All intellectual property rights are reserved. You
                may view and/or print pages from https://www.usecloudpress.com
                for your own personal use subject to restrictions set in these
                terms and conditions.
              </p>
              <p>You must not:</p>
              <ol>
                <li>Republish material from https://www.usecloudpress.com</li>
                <li>
              ...
              <p>
                Redistribute content from Cloudpress (unless content is
              ...
              <p>
                ...
                of Cloudpress; and (d) where the link is in the context of
              ...
              <p>
                ...
                <a
                  ...
                  title="send an email to support@usecloudpress.com"
                >
                  support@usecloudpress.com
                </a>
              ...
              <p>
                No use of Cloudpress&apos;s logo or other artwork will be
